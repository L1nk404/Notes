...
> Estas são as hotkeys padrão. Podem ser alteradas no arquivo de configuração de hotkeys customizadas.
...
> **Nota:** "Quit superfile and cd to current folder" (`cd_quit`) requer a mesma configuração da opção `cd_on_quit`.
...
*Fonte: [superfile.dev/list/hotkey-list](https://superfile.dev/list/hotkey-list/)*
